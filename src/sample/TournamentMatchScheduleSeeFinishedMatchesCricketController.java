...
public class TournamentMatchScheduleSeeFinishedMatchesCricketController implements Initializable {
    ...
    void match_clicked(MouseEvent event) throws IOException {
        ...
        FinishedMatchPlayerStatResultCricketController finishedMatchPlayerStatResultController=new FinishedMatchPlayerStatResultCricketController();
        ...
        AnchorPane pane = FXMLLoader.load(getClass().getClassLoader().getResource("sample/Finished_Match_Player_Stat_Result_Cricket.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        schedule_listview_finished_match.setCellFactory(new Callback<ListView<MatchScheduleClass>, ListCell<MatchScheduleClass>>() {
            ...
            public ListCell<MatchScheduleClass> call(ListView<MatchScheduleClass> param) {
                return new TournamentMatchScheduleSeeFinishedMatchesCricketController.CustomListCell();
            }
...
//                tournament_id1=Integer.parseInt(resultSet1.getString("tournament_id"));
    ...
    public void match_clicked_1(MouseEvent mouseEvent) throws IOException {
