...
public class TournamentsPageController implements Initializable {
    @FXML
    ...
    public void addTournamentPage(ActionEvent actionEvent) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getClassLoader().getResource("sample/Add_Tournaments_Page.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            ResultSet resultSet = statement
                    .executeQuery("select tournament_name FROM tournament where sport_id=1;");
