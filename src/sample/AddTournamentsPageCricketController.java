...
public class AddTournamentsPageCricketController {
    @FXML
    ...
    public void cancel_clicked(ActionEvent actionEvent) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getClassLoader().getResource("sample/Tournaments_Page_Cricket.fxml"));
    ...
    public void seeavailableteams(ActionEvent actionEvent) throws IOException {
        FXMLLoader addNewItemLoader = new FXMLLoader(getClass().getClassLoader().getResource("sample/AvailableTeamForTournamentCricket.fxml"));
