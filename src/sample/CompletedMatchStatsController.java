...
public class CompletedMatchStatsController implements Initializable {
    @FXML
   ...
   int sportid=1;
    ...
    void addButtonClicked(MouseEvent event) throws IOException {
        ...
        FinishedMatchPlayerStatController finishedMatchPlayerStatController = new FinishedMatchPlayerStatController();
        finishedMatchPlayerStatController.pass_info(sportid,tournament_id,match_id_pass,winner_id,loser_id);

        AnchorPane pane = FXMLLoader.load(getClass().getClassLoader().getResource("sample/Finished_Match_Player_Stat.fxml"));
