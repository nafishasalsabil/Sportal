...
public class AddFootballPlayerToTeamDialogBoxController implements Initializable {
            ...
            try {
                ...
                while (resultSet.next()) {
                 ...
                 /*   PreparedStatement stmt =
                    ...
                    stmt.setInt(6, Integer.parseInt(resultSet.getString("instituition_id")));
                    stmt.setInt(7, sports_id);
                    stmt.setInt(8, Integer.parseInt(teamid));
                    stmt.setString(9,height );
                    stmt.setString(10, weight);
                    stmt.setString(11, contact);
                    stmt.setString(12, jersey);
                    stmt.executeUpdate();
                    System.out.println(Integer.parseInt(age)+"-----"+Integer.parseInt(resultSet.getString("instituition_id"))+"-------");
*/
                    PreparedStatement stmt =
                            connection.prepareStatement("insert into players (player_name, player_age, player_role, player_address, player_gender, instituition_id,  sport_id, team_id,player_height, player_weight,contact, player_code) values (?,?,?,?,?,?,?,?,?,?,?,?)");
                    stmt.setString(1, name1);
...
*/
    ...
    public void onInstitutionselected(ActionEvent actionEvent) {
